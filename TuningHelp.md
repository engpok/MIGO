...
### One day the app was perfect, and the next day the suggestion was too warm (or too cold)?
Yes, this can happen from time to time. Weather forecasts are not perfect. However, over the last ten years the weather forecasting has gotten much more accurate. Also, unitl you get the app tuned for you, you might want to error on the more-clothes side with the idea that you can always shed a layer or open a top level to cool down.
